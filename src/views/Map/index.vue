...
<template>
  <div id="main" ref="map">
    <img src="../../assets/mapIcon/ba.png" alt="" class="ba" @click="toBa" />
    <img src="../../assets/mapIcon/fo.png" alt="" class="fo" @click="toFo" />
    <img src="../../assets/mapIcon/wei.png" alt="" class="wei" @click="toWei" />
  </div>
  <ButNav />
</template>
<style scoped>
